  ...
  return (
    <main className="min-h-screen bg-center bg-cover bg-[url('../public/binary-4851165_1280.jpg')] flex justify-center">
      <div className="mt-56 mb-56">
        <h1 className="max-w-3xl text-center font-bold text-5xl leading-tight mb-3 text-gray-50">
          Vault Secrets Manager
        </h1>
        <p className="max-w-3xl text-lg font-medium text-center mb-5 text-gray-50">Simple. Secure. Secret.</p>
